...
struct AgreementView: View {
    @State var agreementContent: String = """
        제1조(목적) \n\n이 약관은 주식회사 나그네들 (이하 "회사"라고 한다)가 온라인으로 제공하는 여행정보 콘텐츠(이하 "콘텐츠"라고 한다) 및 제반 서비스의 이용과 관련하여 회사와 이용자와의 권리, 의무 및 책임사항 등을 규정함을 목적으로 합니다. \n\n제2조(정의) \n
        ...
        6. 아이디(ID)"라 함은 회원의 식별과 서비스이용을 위하여 회원"이 정하고 "회사"가 승인하는 문자 또는 숫자의 조합을 말합니다.
        7. 비밀번호(PASSWORD)"라 함은 회원이 부여받은 아이디"와 일치되는 회원"임을 확인하고 비밀보호를 위해 회원" 자신이 정한 문자 또는 숫자의 조합을 말합니다.\n
        제3조(신원정보 등의 제공) \n
        ...
        """
    @State var agreementContent2: String = """
    제7조(회원가입) \n
    ...
    ③ 만 14세 미만 "이용자의 부모 등 법정대리인은 아동에 대한 개인정보의 열람, 정정, 갱신을 요청하거나 회원가입에 대한 동의를 철회할 수 있으며, 이러한 경우에 "회사"는 지체 없이 필요한 조치를 취해야 합니다. \n
    제9조(회원정보의 변경) \n
    ...
    제10조(회원"의 아이디" 및 "비밀번호의 관리에 대한 의무) \n
    ① "회원"의 "아이디"와 "비밀번호에 관한 관리책임은 "회원"에게 있으며, 이를 제3자가 이용하도록 하여서는 안 됩니다.
    ...
    2. "회사의 서비스이용대금, 기타 "회사의 서비스이용에 관련하여 회원이 부담하는 채무를 기일에 이행하지 않는 경우
    ...
    """
    @State var agreementContent3: String = """
        제13조("콘텐츠"의 내용 등의 게시) \n
        ...
        7. 외설 또는 폭력적인 말이나 글, 화상, 음향, 기타 공서양속에 반하는 정보를 "회사의 사이트에 공개 또는 게시하는 행위
        8. 기타 불법적이거나 부당한 행위
        ② "이용자"는 관계법령, 이 약관의 규정, 이용안내 및 콘텐츠와 관련하여 공지한 주의사항, "회사"가 통지하는 사항 등을 준수하여야 하며, 기타 "회사"의 업무에 방해되는 행위를 하여서는 안 됩니다. \n
        제19조(지급방법) \n
        ...
        ② "회사"는 컴퓨터 등 정보통신설비의 보수점검, 교체 및 고장, 통신두절 또는 운영상 상당한 이유가 있는 경우 콘텐츠서비스의 제공을 일시적으로 중단할 수 있습니다. 이 경우 "회사"는 제11조[회원에 대한 통지]에 정한 방법으로 "이용자"에게 통지합니다. 다만, "회사"가 사전에 통지할 수 없는 부득이한 사유가 있는 경우 사후에 통지할 수 있습니다.
        ...
        ⑤ 사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로 콘텐츠서비스를 제공할 수 없게 되는 경우에는 회사"는 제11조["회원에 대한 통지]에 정한 방법으로 "이용자"에게 통지하고 당초 회사"에서 제시한 조건에 따라 "이용자"에게 보상합니다. 다만, "회사"가 보상기준 등을 고지하지 아니하거나, 고지한 보상기준이 적절하지 않은 경우에는 "이용 자"들의 마일리지 또는 적립금 등을 현물 또는 현금으로 이용자"에게 지급합니다. \n
        제21조(콘텐츠서비스의 변경) \n
        ...
        ③ 제2항의 경우에 변경된 내용이 중대하거나 "이용자"에게 불리한 경우에는 "회사"가 해당 콘텐츠서비스를 제공받는 이용자"에게 제11조["회원"에 대한 통지]에 정한 방법으로 통지하고 동의를 받습니다. 이때, 회사"는 동의를 거절한 이용자"에 대하여는 변경전 서비스를 제공합니다. 다만, 그러한 서비스 제공이 불가능할 경우 계약을 해지할 수 있습니 다.
        ...
        ④ "회사"가 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보관리책임자의 신원(소속, 성명 및 전화번호 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공관련사항(제공받는 자, 제공목적 및 제공할 정보의 내용)등에 관하여 정보통신망이용촉진 및 정보보호 등에 관한 법률 제22조 제2항이 규정한 사항을 명시해 고 고지하여야 합니다.
        ⑤ "이용자"는 언제든지 제3항의 동의를 임의로 철회할 수 있습니다.
        ⑥ "이용자"는 언제든지 회사"가 가지고 있는 자신의 개인정보에 대해 열람 및 오류의 정정을 요구할 수 있으며, "회사"는 이에 대해 지체 없이 필요한 조치를 취할 의무를 집니다. 이용자"가 오류의 정정을 요구한 경우에는 "회사"는 그 오류를 정정할 때까지 당해 개인정보를 이용하지 않습니다.
        ⑦ "회사"는 개인정보보호를 위하여 관리자를 한정하여 그 수를 최소화하며, 신용카드, 은행계좌 등을 포함한 이용자"의 개인정보의 분실, 도난, 유출, 변조 등으로 인한 이용자"의 손해에 대하여 책임을 집니다.
        ⑧ "회사" 또는 그로부터 개인정보"를 제공받은 자는 이용자"가 동의한 범위 내에서 개인정보"를 사용할 수 있으며, 목적이 달성된 경우에는 당해 개인정보"를 지체 없이 파기합니다.
        ⑨ "회사"'는 정보통신망이용촉진 및 정보보호에 관한 법률 등 관계 법령이 정하는 바에 따라 이용자"의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 관련법령 및 "회사"의 개인정보보호정책이 적용됩니다.
        """
    @State var agreementContent4: String = """
        ...
        제27조("이용자의 청약철회와 계약해제•해지의 효과) \n
        ① "회사"는 "이용자"가 청약철회의 의사표시를 한 날로부터 또는 이용자"에게 계약해제해지의 의사표시에 대하여 회신한 날로부터 3영업일 이내에 대금의 결제와 동일한 방법으로 이를 환급하여야 하며, 동일한 방법으로 환불이 불가능할 때에는 이를 사전에 고지하여야 합니다. 이 경우 "회사"가 이용자"에게 환급을 지연한 때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.
        ...
        """
    @State var agreementContent5: String = """
        제30조 취소 및 환불 \n
        (1) 회원은 다음 각 호의 사항에 따라 사이트 및 앱에서 구입한 콘텐츠의 환불 또는 변경을 요청할 수 있습니다. 단, "콘텐츠"를 다운로드 또는 실시간 스트리밍 서비스를 통해 열어보았다면 제공한 콘텐츠"를 이미 이용한 것으로 간주하여 환불이 불가능합니다.
        (2) 구매한 콘텐츠"는 다운로드 또는 스트리밍으로 이용하지 않은 경우 전액 환불이 가능합니다.
        (3) 다음 각 호의 경우에는 이용자가 환불을 요청할 수 없습니다.-"콘텐츠"를 다운로드 또는 스트리밍 서비스를 통해 열람한 경우 - 서비스 업데이트를 통한 문제 해결이 가능함에도 회원의 의사로 이를 거부하여 서비스를 이용하지 못하는 경우- 회원의 실수로 해당 서비스를 이용하지 못하는 경우
        (4) 개별 서비스의 성격에 따라 회사는 별도 약관 및 이용조건에 따른 취소 및 환불 규정을 정할 수 있으며, 이 경우 개별 약관 및 이용조건 상의 취소 및 환불규정이 우선 적용됩니다.
        (5) 기타 본 약관 및 사이트의 이용안내에 규정되지 않은 취소 및 환불에 대한 사항에 대해서는 소비자 피해보상규정에서 정한 바에 따릅니다.\n
        제31조(과오금)\n
        ① "회사"는 과오금이 발생한 경우 이용대금의 결제와 동일한 방법으로 과오금 전액을 환불하여야 합니다. 다만, 동일한 방법으로 환불이 불가능할 때는 이를 사전에 고지합니다.
        ② "회사"의 책임 있는 사유로 과오금이 발생한 경우 "회사"는 계약비용, 수수료 등에 관계없이 과오금 전액을 환불합니다. 다만, 이용자의 책임 있는 사유로 과오금이 발생한 경우, 회사"가 과오금을 환불하는 데 소요되는 비용은 합리적인 범위 내에서 "이용자"가 부담하여야 합니다.
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Text(agreementContent3)
                    .padding(.horizontal)
                    .fixedSize(horizontal: false, vertical: true)
                    .lineSpacing(8)
                    .font(.body)
                
                Text("제4장 콘텐츠 이용계약의 청약철회, 계약해제,해치 및 이용제한")
                    .font(.title)
                    .fontWeight(.bold)
                    .padding()
                
                Text(agreementContent4)
                    .padding(.horizontal)
                    .fixedSize(horizontal: false, vertical: true)
                    .lineSpacing(8)
                    .font(.body)
        ...
        .navigationBarTitle("이용약관", displayMode: .inline)
    }
}
